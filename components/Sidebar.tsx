...
function IconPalette({ active, size = "sm" }: { active: boolean; size?: "sm" | "md" }) {
  const s = SZ[size];
  return (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor"
      strokeWidth={active ? "2" : "1.5"} strokeLinecap="round" strokeLinejoin="round">
...
function IconSettings({ active, size = "sm" }: { active: boolean; size?: "sm" | "md" }) {
  const s = SZ[size];
  return (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor"
      strokeWidth={active ? "2" : "1.5"} strokeLinecap="round" strokeLinejoin="round">
...
export default function Sidebar() {
  ...
  const LINKS = [
    ...
    { href: `/${locale}/art`,             label: t("art"),            Icon: IconPalette   },
    ...(isTherapist ? [{ href: `/${locale}/portal`, label: t("portal"), Icon: IconBriefcase }] : []),
    { href: `/${locale}/settings`, label: t("settings"), Icon: IconSettings },
  ];
